        ...
        <div>
            <a className="banner">
                ...
                <div className="banner-info">
                    ...
                    <p className="banner-4"><a href="" className="">Khám phá </a></p>
                </div>
            </a>
            <div className="services-list">
                <div className="service-item">
                    <a href="" className="service-link"><i class="fa-thin fa-truck-fast"></i><span className="service-name">Freeship</span></a>
                </div>
                <div className="service-item">
                    <a href="" className="service-link"><i class="fa-thin fa-box-circle-check"></i><span className="service-name">Hoàn trả miễn phí </span></a>
                </div>
                <div className="service-item">
                    <a href="" className="service-link"><i class="fa-thin fa-watch-fitness"></i><span className="service-name">Bảo hành 2 năm</span></a>
                </div>
            </div>
        </div>
    );
